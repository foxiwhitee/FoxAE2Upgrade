...
public class TileHybridMolecularAssembler extends TileCustomMolecularAssembler{
    ...
    public TileHybridMolecularAssembler() {
        getProxy().setIdlePowerUsage(FoxConfig.hybrid_molecular_assembler_power);
    }
    ...
    public long getMaxCount() {
        return FoxConfig.hybrid_molecular_assembler_speed - 1L;
    }

    @Override
    protected double getPower() {
        return FoxConfig.hybrid_molecular_assembler_power;
    }
