...
package foxiwhitee.FoxAE2Upgrade.client.gui.widgets;

import appeng.api.config.*;
import appeng.client.gui.widgets.ITooltip;
import appeng.client.texture.ExtraBlockTextures;
import appeng.core.localization.ButtonToolTips;
import foxiwhitee.FoxAE2Upgrade.localization.CustomButtonToolTips;
...
public class CustomGuiImgButton extends GuiButton implements ITooltip {
    ...
    public CustomGuiImgButton(String states, int x, int y, Enum idx, Enum val) {
        ...
        if (appearances == null) {
            ...
            this.registerApp(84, Settings.ACTIONS, (Enum) foxiwhitee.FoxAE2Upgrade.api.config.ActionItems.TOGGLE_SHOW_ONLY_INVALID_PATTERN_ON, CustomButtonToolTips.ToggleShowOnlyInvalidInterface, CustomButtonToolTips.ToggleShowOnlyInvalidInterfaceOnDesc);
            this.registerApp(85, Settings.ACTIONS, (Enum) foxiwhitee.FoxAE2Upgrade.api.config.ActionItems.TOGGLE_SHOW_ONLY_INVALID_PATTERN_OFF, CustomButtonToolTips.ToggleShowOnlyInvalidInterface, CustomButtonToolTips.ToggleShowOnlyInvalidInterfaceOffDesc);
            this.registerApp(86, Settings.ACTIONS, (Enum) foxiwhitee.FoxAE2Upgrade.api.config.ActionItems.MOLECULAR_ASSEMBLEERS_ON, CustomButtonToolTips.ToggleMolecularAssemblers, CustomButtonToolTips.ToggleMolecularAssemblersDescOn);
            this.registerApp(87, Settings.ACTIONS, (Enum) foxiwhitee.FoxAE2Upgrade.api.config.ActionItems.TOGGLE_SHOW_FULL_INTERFACES_ON, CustomButtonToolTips.ToggleShowFullInterfaces, CustomButtonToolTips.ToggleShowFullInterfacesOnDesc);
            this.registerApp(88, Settings.ACTIONS, (Enum) foxiwhitee.FoxAE2Upgrade.api.config.ActionItems.TOGGLE_SHOW_FULL_INTERFACES_OFF, CustomButtonToolTips.ToggleShowFullInterfaces, CustomButtonToolTips.ToggleShowFullInterfacesOffDesc);
            this.registerApp(89, Settings.ACTIONS, (Enum) foxiwhitee.FoxAE2Upgrade.api.config.ActionItems.MOLECULAR_ASSEMBLEERS_OFF, CustomButtonToolTips.ToggleMolecularAssemblers, CustomButtonToolTips.ToggleMolecularAssemblersDescOff);
            this.registerApp(102, Settings.ACTIONS, (Enum) foxiwhitee.FoxAE2Upgrade.api.config.ActionItems.HIGHLIGHT_INTERFACE, CustomButtonToolTips.HighlightInterface, "");
        }
