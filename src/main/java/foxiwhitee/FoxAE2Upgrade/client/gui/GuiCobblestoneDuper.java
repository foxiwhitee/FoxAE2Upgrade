...
public class GuiCobblestoneDuper extends AppengGui {
    ...
    public void drawBG(int offsetX, int offsetY, int mouseX, int mouseY) {
        ...
        if (tile.getTick() > 0) {
            ...
            UtilGui.drawTexture(offsetX + 57 - 23, offsetY + 103 - 28, 0, 243, (int) (l + 1.0D), 6, (int) (l + 1.0D), 6);
        }
        if (tile.getProductivity() > 0) {
            ...
            UtilGui.drawTexture(offsetX + 64 - 26, offsetY + 114 - 28, 0, 250, (int) (l + 1.0D), 6, (int) (l + 1.0D), 6);
        }
    }
