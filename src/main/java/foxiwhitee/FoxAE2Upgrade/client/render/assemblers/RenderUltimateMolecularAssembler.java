...
public class RenderUltimateMolecularAssembler extends TileEntitySpecialRendererObjWrapper<TileUltimateMolecularAssembler> implements IItemRenderer {
    ...
    public RenderUltimateMolecularAssembler() {
        super(TileUltimateMolecularAssembler.class, "models/molecularAssembler.obj", "textures/blocks/assemblers/ultimateMolecularAssembler.png");
        createList("all");
    }
