...
public class RenderAdvancedMolecularAssembler extends TileEntitySpecialRendererObjWrapper<TileAdvancedMolecularAssembler> implements IItemRenderer {
    ...
    public RenderAdvancedMolecularAssembler() {
        super(TileAdvancedMolecularAssembler.class, "models/molecularAssembler.obj", "textures/blocks/assemblers/advancedMolecularAssembler.png");
        createList("all");
    }

    public void renderAt(TileAdvancedMolecularAssembler tileEntity, double x, double y, double z, double f) {
        GL11.glPushMatrix();
        GL11.glEnable(3008);
        GL11.glEnable(3042);
