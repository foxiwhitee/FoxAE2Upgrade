...
public abstract class PartBaseSmartCable extends PartBaseCable {
    ...
    public void renderStatic(int x, int y, int z, IPartRenderHelper rh, RenderBlocks renderer) {
        ...
        for (ForgeDirection of : EnumSet.complementOf(getConnections())) {
            ...
            if (bp instanceof appeng.api.networking.IGridHost) {
                ...
                if (len < 8) {
                    ...
                    rh.setTexture(taughtIcon1, taughtIcon1, taughtIcon1, taughtIcon1, taughtIcon1, taughtIcon1);
                    renderAllFaces((AEBaseBlock) rh.getBlock(), x, y, z, rh, renderer);
                    Tessellator.instance.setColorOpaque_I((getCableColor()).whiteVariant);
                    rh.setTexture(taughtIcon2, taughtIcon2, taughtIcon2, taughtIcon2, taughtIcon2, taughtIcon2);
                    renderAllFaces((AEBaseBlock) rh.getBlock(), x, y, z, rh, renderer);
        ...
        if (sides.size() != 2 || !nonLinear(sides) || hasBuses) {
            ...
            OffsetIcon offsetIcon2 = new OffsetIcon(taughtIcon1, 0.0F, -12.0F);
            TaughtIcon taughtIcon2 = new TaughtIcon(getChannelTex(channels, true).getIcon(), -0.2F);
            OffsetIcon offsetIcon3 = new OffsetIcon(taughtIcon2, 0.0F, -12.0F);
            switch (selectedSide) {
                case DOWN:
                case UP:
                    renderer.setRenderBounds(0.3125D, 0.0D, 0.3125D, 0.6875D, 1.0D, 0.6875D);
                    rh.setTexture(def, def, offsetIcon1, offsetIcon1, offsetIcon1, offsetIcon1);
                    ...
                    Tessellator.instance.setBrightness(15728880);
                    Tessellator.instance.setColorOpaque_I((getCableColor()).blackVariant);
                    rh.setTexture(taughtIcon1, taughtIcon1, offsetIcon2, offsetIcon2, offsetIcon2, offsetIcon2);
                    renderAllFaces((AEBaseBlock) rh.getBlock(), x, y, z, rh, renderer);
                    Tessellator.instance.setColorOpaque_I((getCableColor()).whiteVariant);
                    rh.setTexture(taughtIcon2, taughtIcon2, offsetIcon3, offsetIcon3, offsetIcon3, offsetIcon3);
                    renderAllFaces((AEBaseBlock) rh.getBlock(), x, y, z, rh, renderer);
                    break;
                case EAST:
                case WEST:
                    rh.setTexture(offsetIcon1, offsetIcon1, offsetIcon1, offsetIcon1, def, def);
                    ...
                    rh.renderBlockCurrentBounds(x, y, z, renderer);
                    Tessellator.instance.setBrightness(15728880);
                    fpA = new FlippableIcon(taughtIcon1);
                    fpB = new FlippableIcon(taughtIcon2);
                    fpA = new FlippableIcon(taughtIcon1);
                    fpB = new FlippableIcon(taughtIcon2);
                    fpA.setFlip(true, false);
                    fpB.setFlip(true, false);
                    Tessellator.instance.setColorOpaque_I((getCableColor()).blackVariant);
                    rh.setTexture(offsetIcon2, offsetIcon2, offsetIcon2, offsetIcon2, taughtIcon1, fpA);
                    renderAllFaces((AEBaseBlock) rh.getBlock(), x, y, z, rh, renderer);
                    Tessellator.instance.setColorOpaque_I((getCableColor()).whiteVariant);
                    rh.setTexture(offsetIcon3, offsetIcon3, offsetIcon3, offsetIcon3, taughtIcon2, fpB);
                    renderAllFaces((AEBaseBlock) rh.getBlock(), x, y, z, rh, renderer);
                    break;
                case NORTH:
                case SOUTH:
                    rh.setTexture(offsetIcon1, offsetIcon1, def, def, offsetIcon1, offsetIcon1);
                    ...
                    Tessellator.instance.setBrightness(15728880);
                    Tessellator.instance.setColorOpaque_I((getCableColor()).blackVariant);
                    rh.setTexture(offsetIcon2, offsetIcon2, taughtIcon1, taughtIcon1, offsetIcon2, offsetIcon2);
                    renderAllFaces((AEBaseBlock) rh.getBlock(), x, y, z, rh, renderer);
                    Tessellator.instance.setColorOpaque_I((getCableColor()).whiteVariant);
                    rh.setTexture(offsetIcon3, offsetIcon3, taughtIcon2, taughtIcon2, offsetIcon3, offsetIcon3);
                    renderAllFaces((AEBaseBlock) rh.getBlock(), x, y, z, rh, renderer);
                    break;
            }
        }
